        ...
        return new OpenAPI()
                ...
                .path("/oauth2/token", new PathItem()
                        .post(new Operation()
                                ...
                                .security(List.of())
                                .description("Custom password grant. Returns JWT Bearer token.")
                                        ...
                                        .content(new Content().addMediaType(
                                                ...
                                                new MediaType().schema(new Schema<String>()
                                                        ...
                                                        .addProperty("grant_type",
                                                                new Schema<>().type("string").example("password"))
                                                        ...
                                                        .addProperty("username",
                                                                new Schema<>().type("string").example(clientEmail))
                                                        .addProperty("password",
                                                                new Schema<>().type("string").example(clientPassword))
                                                ...
                                                .content(new Content().addMediaType("application/json",
                                                        new MediaType().schema(new Schema<>().type("object")
                                                                ...
                                                                .addProperty("token_type",
                                                                        new Schema<>().type("string").example("Bearer"))
